...
#,''altes_zutaten.php',
b = ['./http/Views/pages/rezepte.php','./http/Views/templates/rezepteFormular.php','./http/Views/templates/rezepte_post.php','./http/Views/templates/einheiten.html','./http/Views/templates/zutaten_post.php','./http/Views/templates/zutatenFormular.php','./http/Views/templates/einheitenFormular.php','./http/Views/pages/einheiten.php', './http/Views/pages/zutaten.php','sql_create']
# Main script
a = ['./http/Views/pages/rezepte.php','./http/Views/templates/zutatenFormular.php','./http/Views/templates/rezepteFormular.php']
