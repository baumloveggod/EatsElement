...
#,'
# Main script
write_file_info_to_output(['zutatenFormular.php','./http/Views/templates/zutatenFormular.php','./http/Views/templates/einheitenFormular.php','./http/Views/pages/einheiten.php', './http/Views/pages/zutaten.php','sql_create'], 'output.txt')
