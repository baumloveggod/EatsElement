...
function ZutatenForm(){
 ...
 $kategorienOptions = generateOptions( 'kategorien', 'id', 'name'); // Assuming generateOptions() is a function that returns a string
 $phdKategorieOptions = generateOptions('Planetary_Health_Diet_Categories', 'ID', 'Kategorie');
 $einheitenOptions = generateOptions('einheiten', 'id', 'name', true);
